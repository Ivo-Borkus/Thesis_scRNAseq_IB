...
here::i_am("02_scripts/QC_per_sample/sample_2.rmd")
```
...
minfeat <- 300
maxfeat <- 10000
maxmt <- 25 # Looks like there might be some alive cells floating above 20%
```
...
```{R saving seurat}
saveRDS(seurat_obj, file = "03_processing/01_QC/data/subsets/105086-009-003.RDS")
```