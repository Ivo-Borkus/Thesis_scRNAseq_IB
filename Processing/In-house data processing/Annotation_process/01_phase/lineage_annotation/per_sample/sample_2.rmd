...
# params <- rmarkdown::yaml_front_matter("02_scripts/lineage_annotation/per_sample/sample_2.rmd")$params
...
new.cluster.ids <- c("Tcells", "Lymphoid", "Myeloid", "Lymphoid_clonal", "Brain", "Unknown")
