...
# params <- rmarkdown::yaml_front_matter("02_scripts/lineage_annotation/per_sample/sample_8.rmd")$params
...
new.cluster.ids <- c("Tumour", "Lymphoid", "Myeloid", "Brain")
