...
# params <- rmarkdown::yaml_front_matter("02_scripts/lineage_annotation/per_sample/sample_7.rmd")$params
...
FeaturePlot(seurat_obj, features = c("PTPRC", "Myeloid_genes1", "Lymphoid_genes1", "neuronalMarkers1", "MLANA")) & NoAxes()
...
new.cluster.ids <- c("Lymphoid", "Myeloid", "proliferativeLymphoid", "Bcells", "Tumour", "Brain", "pDCs")
