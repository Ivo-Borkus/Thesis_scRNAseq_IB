...
here::i_am("02_scripts/QC_per_sample/sample_3.rmd")
```
...
umi_v_genes_mt_col + labs(title = paste0("Sample: ", sample, " Sample 1 UMI count vs MT percentage"))
```
...
```{R saving seurat}
saveRDS(seurat_obj, file = "03_processing/01_QC/data/subsets/105086-009-005.RDS")
```