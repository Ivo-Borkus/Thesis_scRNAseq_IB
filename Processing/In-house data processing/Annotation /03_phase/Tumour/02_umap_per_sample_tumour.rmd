...
saveRDS(seurat_obj, file = "03_processing/10_integration/data/integrated_tumour.rds")
```


```{R eval = FALSE}
rmarkdown::render(
    input = paste0("02_scripts/03_phase/Tumour/02_umap_per_sample_tumour.rmd"),
    output_format = "html_document",
    output_dir = "/scratch_isilon/groups/singlecell/iborkus/Projects/brain_met/02_scripts/knits/03_phase/Tumour/",
    output_file = paste0("02_umap_per_sample_tumour.html")
)
```
