...
```{R setting variables}
output_fig <- "03_processing/10_integration/figs/all/"
output_data <- NA
input_data <- "03_processing/10_integration/data/merged_scratch.rds"
sample <- "All cells"
...
res_values <- c(0.01, 0.05, 0.1, 0.2, 0.3, 0.5, 0.7, 0.9, 1.5)
seurat_obj@meta.data <- seurat_obj@meta.data[, !grepl("^RNA_snn_res", colnames(seurat_obj@meta.data))]
...
saveRDS(seurat_obj, file = "03_processing/10_integration/data/integrated_all.rds")
```


```{R eval = FALSE}
rmarkdown::render(
    input = paste0("02_scripts/03_phase/All/02_umap_per_sample_all.rmd"),
    output_format = "html_document",
    output_dir = "/scratch_isilon/groups/singlecell/iborkus/Projects/brain_met/02_scripts/knits/03_phase/All/",
    output_file = paste0("02_umap_per_sample_all.html")
)
```
